...
if ($stmt = $mysqli->prepare('SELECT vorname, nachname, email, telefonnummer, passwort, adresse, adresszusatz, plz, ort, land, profB_name, profB_pfad,  pb_versteckt from YogaLehrer join Profilseite on YogaLehrer.Lehrer_ID = Profilseite.FK_Lehrer_ID where YogaLehrer.Lehrer_ID = ?')) {
