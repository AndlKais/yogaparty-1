...
insert into Profilseite (profB_name, profB_pfad, pb_versteckt, FK_Lehrer_ID) values ('yoga.png','resources/pictures/', false, 1);
...
insert into Aktuelles(titel, beschreibung, datum, FK_Lehrer) values ('Das neue Yogastudio neben der HTL Rennweg hat heute eröffnet', 'Dies ist ein Test. Wird gleich wieder entfernt', '2018-06-10',1);
insert into Aktuelles(titel, beschreibung, datum, FK_Lehrer) values ('test', 'oarger test','2018-03-02',1);

/*
SELECT titel, beschreibung, datum, vorname, nachname from Aktuelles join YogaLehrer on YogaLehrer.Lehrer_ID = Aktuelles.FK_Lehrer where YogaLehrer.Lehrer_ID = 1;
select * from Aktuelles;
*/
/*
insert into Aktuelles(titel, beschreibung, datum, FK_Lehrer) values ('Oida typisch Andy', 'Testosteroni', '2018-06-10',1);
insert into Aktuelles(titel, beschreibung, datum, FK_Lehrer) values ('Test2', 'TestTEsT', '2018-06-11',1);
*/
